...
EGLAPI = Enumerant('EGLAPI', 'KHRONOS_APICALL', 'EGL_VERSION_1_0')
EGLAPIENTRY = Enumerant('EGLAPIENTRY', 'KHRONOS_APIENTRY', 'EGL_VERSION_1_0')
EGLAPIENTRYP = Enumerant('EGLAPIENTRYP', 'EGLAPIENTRY *', 'EGL_VERSION_1_0')
EGL_ALPHA_FORMAT = Enumerant('EGL_ALPHA_FORMAT', 'EGL_VG_ALPHA_FORMAT', 'EGL_VERSION_1_0')
EGL_ALPHA_FORMAT_NONPRE = Enumerant('EGL_ALPHA_FORMAT_NONPRE', 'EGL_VG_ALPHA_FORMAT_NONPRE', 'EGL_VERSION_1_0')
EGL_ALPHA_FORMAT_PRE = Enumerant('EGL_ALPHA_FORMAT_PRE', 'EGL_VG_ALPHA_FORMAT_PRE', 'EGL_VERSION_1_0')
EGL_ALPHA_MASK_SIZE = Enumerant('EGL_ALPHA_MASK_SIZE', 0x303e, 'EGL_VERSION_1_0')
EGL_ALPHA_SIZE = Enumerant('EGL_ALPHA_SIZE', 0x3021, 'EGL_VERSION_1_0')
EGL_BACK_BUFFER = Enumerant('EGL_BACK_BUFFER', 0x3084, 'EGL_VERSION_1_0')
EGL_BAD_ACCESS = Enumerant('EGL_BAD_ACCESS', 0x3002, 'EGL_VERSION_1_0')
EGL_BAD_ALLOC = Enumerant('EGL_BAD_ALLOC', 0x3003, 'EGL_VERSION_1_0')
EGL_BAD_ATTRIBUTE = Enumerant('EGL_BAD_ATTRIBUTE', 0x3004, 'EGL_VERSION_1_0')
EGL_BAD_CONFIG = Enumerant('EGL_BAD_CONFIG', 0x3005, 'EGL_VERSION_1_0')
EGL_BAD_CONTEXT = Enumerant('EGL_BAD_CONTEXT', 0x3006, 'EGL_VERSION_1_0')
EGL_BAD_CURRENT_SURFACE = Enumerant('EGL_BAD_CURRENT_SURFACE', 0x3007, 'EGL_VERSION_1_0')
EGL_BAD_DISPLAY = Enumerant('EGL_BAD_DISPLAY', 0x3008, 'EGL_VERSION_1_0')
EGL_BAD_MATCH = Enumerant('EGL_BAD_MATCH', 0x3009, 'EGL_VERSION_1_0')
EGL_BAD_NATIVE_PIXMAP = Enumerant('EGL_BAD_NATIVE_PIXMAP', 0x300a, 'EGL_VERSION_1_0')
EGL_BAD_NATIVE_WINDOW = Enumerant('EGL_BAD_NATIVE_WINDOW', 0x300b, 'EGL_VERSION_1_0')
EGL_BAD_PARAMETER = Enumerant('EGL_BAD_PARAMETER', 0x300c, 'EGL_VERSION_1_0')
EGL_BAD_SURFACE = Enumerant('EGL_BAD_SURFACE', 0x300d, 'EGL_VERSION_1_0')
EGL_BIND_TO_TEXTURE_RGB = Enumerant('EGL_BIND_TO_TEXTURE_RGB', 0x3039, 'EGL_VERSION_1_0')
EGL_BIND_TO_TEXTURE_RGBA = Enumerant('EGL_BIND_TO_TEXTURE_RGBA', 0x303a, 'EGL_VERSION_1_0')
EGL_BLUE_SIZE = Enumerant('EGL_BLUE_SIZE', 0x3022, 'EGL_VERSION_1_0')
EGL_BUFFER_DESTROYED = Enumerant('EGL_BUFFER_DESTROYED', 0x3095, 'EGL_VERSION_1_0')
EGL_BUFFER_PRESERVED = Enumerant('EGL_BUFFER_PRESERVED', 0x3094, 'EGL_VERSION_1_0')
EGL_BUFFER_SIZE = Enumerant('EGL_BUFFER_SIZE', 0x3020, 'EGL_VERSION_1_0')
EGL_CLIENT_APIS = Enumerant('EGL_CLIENT_APIS', 0x308d, 'EGL_VERSION_1_0')
EGL_COLORSPACE = Enumerant('EGL_COLORSPACE', 'EGL_VG_COLORSPACE', 'EGL_VERSION_1_0')
EGL_COLORSPACE_LINEAR = Enumerant('EGL_COLORSPACE_LINEAR', 'EGL_VG_COLORSPACE_LINEAR', 'EGL_VERSION_1_0')
EGL_COLORSPACE_sRGB = Enumerant('EGL_COLORSPACE_sRGB', 'EGL_VG_COLORSPACE_sRGB', 'EGL_VERSION_1_0')
EGL_COLOR_BUFFER_TYPE = Enumerant('EGL_COLOR_BUFFER_TYPE', 0x303f, 'EGL_VERSION_1_0')
EGL_CONFIG_CAVEAT = Enumerant('EGL_CONFIG_CAVEAT', 0x3027, 'EGL_VERSION_1_0')
EGL_CONFIG_ID = Enumerant('EGL_CONFIG_ID', 0x3028, 'EGL_VERSION_1_0')
EGL_CONFORMANT = Enumerant('EGL_CONFORMANT', 0x3042, 'EGL_VERSION_1_0')
EGL_CONTEXT_CLIENT_TYPE = Enumerant('EGL_CONTEXT_CLIENT_TYPE', 0x3097, 'EGL_VERSION_1_0')
EGL_CONTEXT_CLIENT_VERSION = Enumerant('EGL_CONTEXT_CLIENT_VERSION', 0x3098, 'EGL_VERSION_1_0')
EGL_CONTEXT_LOST = Enumerant('EGL_CONTEXT_LOST', 0x300e, 'EGL_VERSION_1_0')
EGL_CORE_NATIVE_ENGINE = Enumerant('EGL_CORE_NATIVE_ENGINE', 0x305b, 'EGL_VERSION_1_0')
EGL_DEFAULT_DISPLAY = Enumerant('EGL_DEFAULT_DISPLAY', '((EGLNativeDisplayType)0)', 'EGL_VERSION_1_0')
EGL_DEPTH_SIZE = Enumerant('EGL_DEPTH_SIZE', 0x3025, 'EGL_VERSION_1_0')
EGL_DISPLAY_SCALING = Enumerant('EGL_DISPLAY_SCALING', 0x2710, 'EGL_VERSION_1_0')
EGL_DONT_CARE = Enumerant('EGL_DONT_CARE', '((EGLint)-1)', 'EGL_VERSION_1_0')
EGL_DRAW = Enumerant('EGL_DRAW', 0x3059, 'EGL_VERSION_1_0')
EGL_EXTENSIONS = Enumerant('EGL_EXTENSIONS', 0x3055, 'EGL_VERSION_1_0')
EGL_FALSE = Enumerant('EGL_FALSE', 0x0000, 'EGL_VERSION_1_0')
EGL_GREEN_SIZE = Enumerant('EGL_GREEN_SIZE', 0x3023, 'EGL_VERSION_1_0')
EGL_HEIGHT = Enumerant('EGL_HEIGHT', 0x3056, 'EGL_VERSION_1_0')
EGL_HORIZONTAL_RESOLUTION = Enumerant('EGL_HORIZONTAL_RESOLUTION', 0x3090, 'EGL_VERSION_1_0')
EGL_LARGEST_PBUFFER = Enumerant('EGL_LARGEST_PBUFFER', 0x3058, 'EGL_VERSION_1_0')
EGL_LEVEL = Enumerant('EGL_LEVEL', 0x3029, 'EGL_VERSION_1_0')
EGL_LUMINANCE_BUFFER = Enumerant('EGL_LUMINANCE_BUFFER', 0x308f, 'EGL_VERSION_1_0')
EGL_LUMINANCE_SIZE = Enumerant('EGL_LUMINANCE_SIZE', 0x303d, 'EGL_VERSION_1_0')
EGL_MATCH_NATIVE_PIXMAP = Enumerant('EGL_MATCH_NATIVE_PIXMAP', 0x3041, 'EGL_VERSION_1_0')
EGL_MAX_PBUFFER_HEIGHT = Enumerant('EGL_MAX_PBUFFER_HEIGHT', 0x302a, 'EGL_VERSION_1_0')
EGL_MAX_PBUFFER_PIXELS = Enumerant('EGL_MAX_PBUFFER_PIXELS', 0x302b, 'EGL_VERSION_1_0')
EGL_MAX_PBUFFER_WIDTH = Enumerant('EGL_MAX_PBUFFER_WIDTH', 0x302c, 'EGL_VERSION_1_0')
EGL_MAX_SWAP_INTERVAL = Enumerant('EGL_MAX_SWAP_INTERVAL', 0x303c, 'EGL_VERSION_1_0')
EGL_MIN_SWAP_INTERVAL = Enumerant('EGL_MIN_SWAP_INTERVAL', 0x303b, 'EGL_VERSION_1_0')
EGL_MIPMAP_LEVEL = Enumerant('EGL_MIPMAP_LEVEL', 0x3083, 'EGL_VERSION_1_0')
EGL_MIPMAP_TEXTURE = Enumerant('EGL_MIPMAP_TEXTURE', 0x3082, 'EGL_VERSION_1_0')
EGL_MULTISAMPLE_RESOLVE = Enumerant('EGL_MULTISAMPLE_RESOLVE', 0x3099, 'EGL_VERSION_1_0')
EGL_MULTISAMPLE_RESOLVE_BOX = Enumerant('EGL_MULTISAMPLE_RESOLVE_BOX', 0x309b, 'EGL_VERSION_1_0')
EGL_MULTISAMPLE_RESOLVE_BOX_BIT = Enumerant('EGL_MULTISAMPLE_RESOLVE_BOX_BIT', 0x0200, 'EGL_VERSION_1_0')
EGL_MULTISAMPLE_RESOLVE_DEFAULT = Enumerant('EGL_MULTISAMPLE_RESOLVE_DEFAULT', 0x309a, 'EGL_VERSION_1_0')
EGL_NATIVE_RENDERABLE = Enumerant('EGL_NATIVE_RENDERABLE', 0x302d, 'EGL_VERSION_1_0')
EGL_NATIVE_VISUAL_ID = Enumerant('EGL_NATIVE_VISUAL_ID', 0x302e, 'EGL_VERSION_1_0')
EGL_NATIVE_VISUAL_TYPE = Enumerant('EGL_NATIVE_VISUAL_TYPE', 0x302f, 'EGL_VERSION_1_0')
EGL_NONE = Enumerant('EGL_NONE', 0x3038, 'EGL_VERSION_1_0')
EGL_NON_CONFORMANT_CONFIG = Enumerant('EGL_NON_CONFORMANT_CONFIG', 0x3051, 'EGL_VERSION_1_0')
EGL_NOT_INITIALIZED = Enumerant('EGL_NOT_INITIALIZED', 0x3001, 'EGL_VERSION_1_0')
EGL_NO_CONTEXT = Enumerant('EGL_NO_CONTEXT', '((EGLContext)0)', 'EGL_VERSION_1_0')
EGL_NO_DISPLAY = Enumerant('EGL_NO_DISPLAY', '((EGLDisplay)0)', 'EGL_VERSION_1_0')
EGL_NO_SURFACE = Enumerant('EGL_NO_SURFACE', '((EGLSurface)0)', 'EGL_VERSION_1_0')
EGL_NO_TEXTURE = Enumerant('EGL_NO_TEXTURE', 0x305c, 'EGL_VERSION_1_0')
EGL_OPENGL_API = Enumerant('EGL_OPENGL_API', 0x30a2, 'EGL_VERSION_1_0')
EGL_OPENGL_BIT = Enumerant('EGL_OPENGL_BIT', 0x0008, 'EGL_VERSION_1_0')
EGL_OPENGL_ES2_BIT = Enumerant('EGL_OPENGL_ES2_BIT', 0x0004, 'EGL_VERSION_1_0')
EGL_OPENGL_ES_API = Enumerant('EGL_OPENGL_ES_API', 0x30a0, 'EGL_VERSION_1_0')
EGL_OPENGL_ES_BIT = Enumerant('EGL_OPENGL_ES_BIT', 0x0001, 'EGL_VERSION_1_0')
EGL_OPENVG_API = Enumerant('EGL_OPENVG_API', 0x30a1, 'EGL_VERSION_1_0')
EGL_OPENVG_BIT = Enumerant('EGL_OPENVG_BIT', 0x0002, 'EGL_VERSION_1_0')
EGL_OPENVG_IMAGE = Enumerant('EGL_OPENVG_IMAGE', 0x3096, 'EGL_VERSION_1_0')
EGL_PBUFFER_BIT = Enumerant('EGL_PBUFFER_BIT', 0x0001, 'EGL_VERSION_1_0')
EGL_PIXEL_ASPECT_RATIO = Enumerant('EGL_PIXEL_ASPECT_RATIO', 0x3092, 'EGL_VERSION_1_0')
EGL_PIXMAP_BIT = Enumerant('EGL_PIXMAP_BIT', 0x0002, 'EGL_VERSION_1_0')
EGL_READ = Enumerant('EGL_READ', 0x305a, 'EGL_VERSION_1_0')
EGL_RED_SIZE = Enumerant('EGL_RED_SIZE', 0x3024, 'EGL_VERSION_1_0')
EGL_RENDERABLE_TYPE = Enumerant('EGL_RENDERABLE_TYPE', 0x3040, 'EGL_VERSION_1_0')
EGL_RENDER_BUFFER = Enumerant('EGL_RENDER_BUFFER', 0x3086, 'EGL_VERSION_1_0')
EGL_RGB_BUFFER = Enumerant('EGL_RGB_BUFFER', 0x308e, 'EGL_VERSION_1_0')
EGL_SAMPLES = Enumerant('EGL_SAMPLES', 0x3031, 'EGL_VERSION_1_0')
EGL_SAMPLE_BUFFERS = Enumerant('EGL_SAMPLE_BUFFERS', 0x3032, 'EGL_VERSION_1_0')
EGL_SINGLE_BUFFER = Enumerant('EGL_SINGLE_BUFFER', 0x3085, 'EGL_VERSION_1_0')
EGL_SLOW_CONFIG = Enumerant('EGL_SLOW_CONFIG', 0x3050, 'EGL_VERSION_1_0')
EGL_STENCIL_SIZE = Enumerant('EGL_STENCIL_SIZE', 0x3026, 'EGL_VERSION_1_0')
EGL_SUCCESS = Enumerant('EGL_SUCCESS', 0x3000, 'EGL_VERSION_1_0')
EGL_SURFACE_TYPE = Enumerant('EGL_SURFACE_TYPE', 0x3033, 'EGL_VERSION_1_0')
EGL_SWAP_BEHAVIOR = Enumerant('EGL_SWAP_BEHAVIOR', 0x3093, 'EGL_VERSION_1_0')
EGL_SWAP_BEHAVIOR_PRESERVED_BIT = Enumerant('EGL_SWAP_BEHAVIOR_PRESERVED_BIT', 0x0400, 'EGL_VERSION_1_0')
EGL_TEXTURE_2D = Enumerant('EGL_TEXTURE_2D', 0x305f, 'EGL_VERSION_1_0')
EGL_TEXTURE_FORMAT = Enumerant('EGL_TEXTURE_FORMAT', 0x3080, 'EGL_VERSION_1_0')
EGL_TEXTURE_RGB = Enumerant('EGL_TEXTURE_RGB', 0x305d, 'EGL_VERSION_1_0')
EGL_TEXTURE_RGBA = Enumerant('EGL_TEXTURE_RGBA', 0x305e, 'EGL_VERSION_1_0')
EGL_TEXTURE_TARGET = Enumerant('EGL_TEXTURE_TARGET', 0x3081, 'EGL_VERSION_1_0')
EGL_TRANSPARENT_BLUE_VALUE = Enumerant('EGL_TRANSPARENT_BLUE_VALUE', 0x3035, 'EGL_VERSION_1_0')
EGL_TRANSPARENT_GREEN_VALUE = Enumerant('EGL_TRANSPARENT_GREEN_VALUE', 0x3036, 'EGL_VERSION_1_0')
EGL_TRANSPARENT_RED_VALUE = Enumerant('EGL_TRANSPARENT_RED_VALUE', 0x3037, 'EGL_VERSION_1_0')
EGL_TRANSPARENT_RGB = Enumerant('EGL_TRANSPARENT_RGB', 0x3052, 'EGL_VERSION_1_0')
EGL_TRANSPARENT_TYPE = Enumerant('EGL_TRANSPARENT_TYPE', 0x3034, 'EGL_VERSION_1_0')
EGL_TRUE = Enumerant('EGL_TRUE', 0x0001, 'EGL_VERSION_1_0')
EGL_UNKNOWN = Enumerant('EGL_UNKNOWN', '((EGLint)-1)', 'EGL_VERSION_1_0')
EGL_VENDOR = Enumerant('EGL_VENDOR', 0x3053, 'EGL_VERSION_1_0')
EGL_VERSION = Enumerant('EGL_VERSION', 0x3054, 'EGL_VERSION_1_0')
EGL_VERTICAL_RESOLUTION = Enumerant('EGL_VERTICAL_RESOLUTION', 0x3091, 'EGL_VERSION_1_0')
EGL_VG_ALPHA_FORMAT = Enumerant('EGL_VG_ALPHA_FORMAT', 0x3088, 'EGL_VERSION_1_0')
EGL_VG_ALPHA_FORMAT_NONPRE = Enumerant('EGL_VG_ALPHA_FORMAT_NONPRE', 0x308b, 'EGL_VERSION_1_0')
EGL_VG_ALPHA_FORMAT_PRE = Enumerant('EGL_VG_ALPHA_FORMAT_PRE', 0x308c, 'EGL_VERSION_1_0')
EGL_VG_ALPHA_FORMAT_PRE_BIT = Enumerant('EGL_VG_ALPHA_FORMAT_PRE_BIT', 0x0040, 'EGL_VERSION_1_0')
EGL_VG_COLORSPACE = Enumerant('EGL_VG_COLORSPACE', 0x3087, 'EGL_VERSION_1_0')
EGL_VG_COLORSPACE_LINEAR = Enumerant('EGL_VG_COLORSPACE_LINEAR', 0x308a, 'EGL_VERSION_1_0')
EGL_VG_COLORSPACE_LINEAR_BIT = Enumerant('EGL_VG_COLORSPACE_LINEAR_BIT', 0x0020, 'EGL_VERSION_1_0')
EGL_VG_COLORSPACE_sRGB = Enumerant('EGL_VG_COLORSPACE_sRGB', 0x3089, 'EGL_VERSION_1_0')
EGL_WIDTH = Enumerant('EGL_WIDTH', 0x3057, 'EGL_VERSION_1_0')
EGL_WINDOW_BIT = Enumerant('EGL_WINDOW_BIT', 0x0004, 'EGL_VERSION_1_0')
